...
// reject bare `params.ID` for dynamic-DB users on NS-enabled clusters. Bare OIDC
// ids name a global OIDC user (subject oidc::<name>) and are accepted; static
// API-key users pass through.
