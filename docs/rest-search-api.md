...
> `search.bm25`). Enabled by default; opt out with
> `DISABLE_REST_SEARCH=true` (gates every search endpoint).
...
reserved-field 422s, `DISABLE_REST_SEARCH`, op-mode read classification —
